...
class Stored_Item (models.Model):
    ...
    def get_stored_item_last_in_first_out_list(cls, item_id) -> list:
        ...
        Returns:
            A list list which is orderd from the most recent date to the latest date or
            False if the item is not stored currently in the storage
        """
...
class Reservated_Destoring_Item (models.Model):
    ...
    stored_item_id = models.ForeignKey(Stored_Item, on_delete=models.CASCADE, related_name="reservated_destoring_item", db_column="stored_item_id")
...
class Reservated_Storing_Item (models.Model):
    ...
    stored_item_id = models.ForeignKey(Stored_Item, on_delete=models.CASCADE, related_name="reservation_storing_item", db_column="stored_item_id")  # FOREIGN KEY (item_id) REFERENCES Bins (item_id)
